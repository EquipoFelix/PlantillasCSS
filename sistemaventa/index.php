...
<form action="login.php" method="post">
			...
			<font style=" font:bold 25px 'Aleo'; text-shadow:1px 1px 15px #000; color:#fff;"><center>ENTRAR AL PUNTO DE VENTA</center></font>
		<br>
...
<div class="input-prepend">
	<span style="height:30px; width:25px;" class="add-on"><i class="icon-lock icon-2x"></i></span><input type="password" style="height:40px;" name="password" Placeholder="PASSWORD" required/><br>
		...
		<div class="qwe">
		 <button class="btn btn-large btn-primary btn-block pull-right" href="dashboard.html" type="submit"><i class="icon-signin icon-large"></i> ENTRAR</button>
</div>
		 </form>
</div>
</div>
